...
class SmartPackageBuildInputSLZ(serializers.Serializer):
    """s-mart Package build request parameters SLZ"""

    app_code = serializers.CharField(help_text="应用 code")
    signature = serializers.CharField(help_text="数字签名")


class SmartPackageBuildOutputSLZ(serializers.Serializer):
    """s-mart Package build response SLZ"""
